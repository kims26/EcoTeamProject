...
public class KakaoSearch1Action extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		List<Location1Vo> list = KakaoSearch1Utils.search1Keyword(query,latitude, longitude, 1, 10);
...
//		}
		...
		//Dispatcher
		String forward_page = "kakao1_keyword_list.jsp";
